...
function Form() {
  const navigate = useNavigate(); //is moved to BackButton component
  ...
  function converToEmoji(countryCode) {
  ...
  useEffect(
    function () {
      //if there is no location, don't show anything
      if (!lat && !lng) return;
      async function fetchCityData() {
        try {
          ...
          if (!data.countryCode) throw new Error("The location is unknown 🤔");
    ...
    >
      ...
      <div className={styles.row}>
        ...
        {/* <input
          ...
          value={date}
        /> */}
        {/* here we save the chosen date with seledcted props and not with value. */}
        <DatePicker
